...
export const birthdayData = {
  ...
  firstPhoto: `${basePath}/images/photo-01.jpg`,
  story: [
  ...
  memories: Array.from({ length: 12 }, (_, index) => ({
    src: `${basePath}/images/photo-${String(index + 1).padStart(2, "0")}.jpg`,
  ...
  emotionalPhoto: `${basePath}/images/photo-13.jpg`,
  ...
  musicSrc: `${basePath}/audio/our-song.mp3`
} as const;
